...
static const char *fullscreenshot[] = {"sh", "-c", "~/.scripts/screenshot.sh", NULL};
static const char *partscreenshot[] = {"sh", "-c", "~/.scripts/screenshot.sh 1", NULL};

static const char *sessionlock[] = {"sh", "-c", "~/.scripts/screenlock.sh", NULL};
